...
access_granted = "🔓 Доступ к ПУ предоставлен!\n\n"\
                 ...
                 "⚙️ Чтобы открыть меню настроек <i>FunPay Celestial</i>, введи команду /menu."
...
❌ <i>FunPay Celestial</i> еще <b><u>не инициализирован</u></b> и <b><u>никакие его функции не работают</u></b>.\n
🔃 Как только <i>FunPay Celestial</i> инициализируется, данное сообщение изменится.\n
📋 Если <i>FPC</i> долго не инициализируется, проверь логи с помощью команды /logs"""

fpc_init = """✅ <b><u>FunPay Celestial инициализирован!</u></b>\n
...
update_lasted = "✅ У тебя стоит последняя версия FunPayCelestial {}"
