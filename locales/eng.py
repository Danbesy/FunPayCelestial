...
access_granted = "🔓 Access granted!\n\n"\
                 ...
                 "⚙️ To open the <i>FunPay Celestial</i> settings menu, send me /menu."
...
❌ <i>FunPay Celestial</i> is not initialized yet and none of its functions work.\n
🔃 As soon as <i>FunPay Celestial</i> is initialized, this message will change.\n
📋 If <i>FPC</i> does not initialize for a long time, check the logs with /logs"""

fpc_init = """✅ <b><u>FunPay Celestial initialized!</u></b>\n
...
update_lasted = "✅ You have the latest version FunPayCelestial {}"
