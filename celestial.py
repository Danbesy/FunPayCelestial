...
class Celestial(object):
    def __new__(cls, *args, **kwargs):
        if not hasattr(cls, "instance"):
            cls.instance = super(Celestial, cls).__new__(cls)
    ...
    def __init__(self, main_config: ConfigParser,
        ...
        self.blacklist = celestial_tools.load_blacklist()  # ЧС.
        self.old_users = celestial_tools.load_old_users()  # Уже написавшие пользователи.
        ...
        self.disabled_plugins = celestial_tools.load_disabled_plugins()
    ...
    def __init_account(self) -> None:
        ...
        while True:
            try:
                ...
                greeting_text = celestial_tools.create_greeting_text(self)
        ...
        for subcat in self.profile.get_sorted_lots(2):
            ...
            try:
                ...
                if e.wait_time is not None:
                    logger.warning(_("crd_raise_time_err", subcat.category.name, celestial_tools.time_to_str(e.wait_time)))
            ...
            logger.info(_("crd_raise_wait_3600", celestial_tools.time_to_str(3600)))
    ...
    def parse_message_entities(self, msg_text: str) -> list[str | int | float]:
        ...
        pos = 0
        entities = []
        while entity := celestial_tools.ENTITY_RE.search(msg_text, pos=pos):
    ...
    def toggle_plugin(self, uuid):
        ...
        celestial_tools.cache_disabled_plugins(self.disabled_plugins)
